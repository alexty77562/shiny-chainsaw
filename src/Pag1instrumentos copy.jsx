...
root.render(
  <React.StrictMode>
    ...
    <Testimonials
    titulo="INSTRUMENTOS"
    cargo1="HISTORIA DE LOS INTRUMENTOS"
    ...
    titulo1="Cuerda"
    titulo2="Percusion"
    texto1="Son instrumentos maravillos"
    texto2="Son instrumentos maravillos"
    ...
    titulo="Instrumentos Mas Populares"
    titulo1="Guitarra"
    titulo2="Violin"
    ...
    texto1="El Acordeon Es un instrumento hermoso."
    ...
    titulo1="EN LA ANTIGUEDAD"
    titulo2="EN LA ACTUALIDA"
    titulo3="EN EL FUTURO"
    texto1="La historia de los instrumentos es maravillo."
    texto2="Los instrumentos en la actualida son esplendidos."
    texto3="El futuro de la musica es increible."
